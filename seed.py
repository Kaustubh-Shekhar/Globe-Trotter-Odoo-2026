...
CITIES = [
    ...
    ("Jaisalmer",     "Rajasthan",         26.9157, 70.9083, 1, 74, "photo-1609920658906-8223bd289001"),
    ("Jodhpur",       "Rajasthan",         26.2389, 73.0243, 1, 72, "photo-1609766857041-ed402ea8069a"),
    ...
    ("Rishikesh",     "Uttarakhand",       30.0869, 78.2676, 1, 79, "photo-1626621341517-bbf3d9990a23"),
    ...
    ("Hampi",         "Karnataka",         15.3350, 76.4600, 1, 70, "photo-1600112356915-089abb8fc71a"),
    ("Mysuru",        "Karnataka",         12.2958, 76.6394, 1, 69, "photo-1600112356915-089abb8fc71a"),
    ("Kochi",         "Kerala",             9.9312, 76.2673, 2, 78, "photo-1593693411515-c20261bcad6e"),
    ...
    ("Ooty",          "Tamil Nadu",        11.4102, 76.6950, 1, 66, "photo-1591017403286-fd8493524e1e"),
    ...
    ("Puri",          "Odisha",            19.8135, 85.8312, 1, 62, "photo-1600112356915-089abb8fc71a"),
    ("Ahmedabad",     "Gujarat",           23.0225, 72.5714, 1, 65, "photo-1572445271230-a78b5944a659"),
